...
- **Body:**
  ```json
  { "update": "string", "description": "string", "link": "string (optional)", "date": "string" }
  ```
...
- **Body:**
  ```json
  { "highlight": "string", "description": "string", "link": "string (optional)", "date": "string" }
  ```
...
- **Body:**
  ```json
  { "name": "string", "description": "string", "imageURL": "string (optional)" }
  ```
